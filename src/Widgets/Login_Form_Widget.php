 ...
 */
class Login_Form_Widget extends Base_Widget {
	...
	public function get_name(): string {
		return 'smart_loginizer_login_form';
	}
	...
	public function get_title(): string {
		return __( 'Login Form', 'smart-loginizer' );
	}
	...
	protected function register_controls(): void {
		...
		$this->add_control(
			...
			array(
				...
				'default' => __( 'Log In', 'smart-loginizer' ),
			)
		);
		...
		$this->add_control(
			'enable_ajax',
			array(
				'label'        => __( 'Enable AJAX', 'smart-loginizer' ),
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					...
					'after_remember' => __( 'After Remember Me', 'smart-loginizer' ),
		...
		$this->add_control(
			'username_label',
			array(
				'label'   => __( 'Username/Email Label', 'smart-loginizer' ),
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Username / Email', 'smart-loginizer' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'   => __( 'Username/Email Placeholder', 'smart-loginizer' ),
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Enter your username or email', 'smart-loginizer' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Enter your password', 'smart-loginizer' ),
			)
		);
		...
		$this->add_control(
			'show_remember_me',
			array(
				'label'        => __( 'Show Remember Me', 'smart-loginizer' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => __( 'Yes', 'smart-loginizer' ),
				'label_off'    => __( 'No', 'smart-loginizer' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'remember_me_text',
			array(
				'label'     => __( 'Remember Me Text', 'smart-loginizer' ),
				'type'      => Controls_Manager::TEXT,
				'default'   => __( 'Remember me', 'smart-loginizer' ),
				'condition' => array(
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .smart-loginizer-login-form' => 'width: {{SIZE}}{{UNIT}}; max-width: 100%;',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .smart-loginizer-login-form' => 'height: {{SIZE}}{{UNIT}} !important; overflow-y: auto;',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .smart-loginizer-login-form' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				'name'     => 'form_border',
				'selector' => '{{WRAPPER}} .smart-loginizer-login-form',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'size_units' => array( 'px', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .smart-loginizer-login-form' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'default' => 'center',
				'selectors' => array(
					'{{WRAPPER}} .smart-loginizer-login-form' => 'text-align: {{VALUE}};',
		...
		$this->add_responsive_control(
			...
			array(
				...
				'default' => 'left',
				'selectors' => array(
					'{{WRAPPER}} .smart-loginizer-form-field label:has(input[type="checkbox"][name="remember"])' => 'text-align: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .smart-loginizer-form-field label:has(input[type="checkbox"][name="remember"])',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .smart-loginizer-form-field label:has(input[type="checkbox"][name="remember"])' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .smart-loginizer-form-field:has(input[type="checkbox"][name="remember"])' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .smart-loginizer-form-field input[type="checkbox"][name="remember"]' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .smart-loginizer-form-field input[type="checkbox"][name="remember"]' => 'accent-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .smart-loginizer-form-field input[type="checkbox"][name="remember"]',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .smart-loginizer-form-field input[type="checkbox"][name="remember"]' => 'border-radius: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .smart-loginizer-form-field input[type="checkbox"][name="remember"]' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .smart-loginizer-form-field label:has(input[type="checkbox"][name="remember"]):hover' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .smart-loginizer-form-field input[type="checkbox"][name="remember"]:hover' => 'border-color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			'button_hover_box_shadow_heading',
			array(
				'label'     => __( 'Hover Box Shadow', 'smart-loginizer' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
	...
	protected function render(): void {
		...
		if ( is_user_logged_in() && ! $show_when_logged_in ) {
			...
			$logged_in_message = $settings['logged_in_message'] ?? /* translators: %s: User display name */
				__( 'You are already logged in as %s.', 'smart-loginizer' );
			?>
			<div class="smart-loginizer-login-form">
		...
		$submit_text        = $settings['submit_button_text'] ?? __( 'Log In', 'smart-loginizer' );
		$redirect           = $settings['redirect_after_login']['url'] ?? '';
		$ajax_enabled       = 'yes' === ( $settings['enable_ajax'] ?? 'yes' );
		$username_label      = $settings['username_label'] ?? __( 'Username / Email', 'smart-loginizer' );
		...
		$username_placeholder = $settings['username_placeholder'] ?? __( 'Enter your username or email', 'smart-loginizer' );
		$password_label      = $settings['password_label'] ?? __( 'Password', 'smart-loginizer' );
		$password_placeholder = $settings['password_placeholder'] ?? __( 'Enter your password', 'smart-loginizer' );
		$show_remember_me     = 'yes' === ( $settings['show_remember_me'] ?? 'yes' );
		$remember_me_text     = $settings['remember_me_text'] ?? __( 'Remember me', 'smart-loginizer' );
		...
		$form_class = 'smart-loginizer-login-form';
		if ( $ajax_enabled ) {
			$form_class .= ' smart-loginizer-ajax-form';
		}
		...
		<form class="<?php echo esc_attr( $form_class ); ?>" method="post">
			...
			<div class="smart-loginizer-form-field">
				<label for="login_username"><?php echo esc_html( $username_label ); ?></label>
				<div class="smart-loginizer-input-wrapper smart-loginizer-icon-<?php echo esc_attr( $username_icon_position ); ?>">
					...
					<?php endif; ?>
					<input type="text" id="login_username" name="username" placeholder="<?php echo esc_attr( $username_placeholder ); ?>" required />
			...
			<div class="smart-loginizer-form-field">
				<label for="login_password"><?php echo esc_html( $password_label ); ?></label>
				<div class="smart-loginizer-input-wrapper smart-loginizer-icon-<?php echo esc_attr( $password_icon_position ); ?>">
					...
					<?php endif; ?>
					<input type="password" id="login_password" name="password" placeholder="<?php echo esc_attr( $password_placeholder ); ?>" required />
					<?php if ( $show_password_toggle ) : ?>
						<button type="button" class="smart-loginizer-password-toggle" aria-label="<?php esc_attr_e( 'Toggle password visibility', 'smart-loginizer' ); ?>" data-target="login_password">
			...
			<?php if ( $recaptcha_enabled && ! empty( $recaptcha_site_key ) ) : ?>
				...
				<?php if ( 'v2_checkbox' === $recaptcha_version ) : ?>
					<div class="smart-loginizer-form-field">
						<div id="recaptcha_v2_login" class="smart-loginizer-recaptcha-v2"></div>
					</div>
				<?php elseif ( 'v2_invisible' === $recaptcha_version ) : ?>
					<div id="recaptcha_v2_invisible_login" class="smart-loginizer-recaptcha-v2-invisible"></div>
				<?php endif; ?>
			<?php endif; ?>
